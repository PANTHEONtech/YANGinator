...
public class GrammarKitRFCUncomplaintUtils {
    ...
    private static void additionalRules(List<String> lines) {
        ...
        lines.add("");
        lines.add("COMCHAR ::= SINGLE_QUOTE | DOUBLE_QUOTE | CARRIAGE_RETURN | BACK_SLASH | ESCAPES | SPACE | SEMICOLON | LEFT_BRACE | RIGHT_BRACE | TAB | LINEFEED sep | LINEFEED | CARRIAGE_RETURNLINEFEED | DATE | FRACTIONS | ZEROS | ALPHANUMERICAL_ALPHA_FIRST | ALPHANUMERICAL_DIGIT_FIRST | IPV4 | DIGITS | CHARS | APOSTROPHE | EXCLAMATION_MARK | HASH | DOLLAR_SIGN | PERCENT_SIGN | AMPERSAND | LEFT_PARENTHESIS | RIGHT_PARENTHESIS | PLUS_SIGN | COMMA | DASH | DOT | FORWARD_SLASH | DOUBLE_FORWARD_SLASH | ZERO | ONE | TWO | THREE | FOUR | FIVE | SIX | SEVEN | EIGHT | NINE | COLON |  LESS_THAN_SIGN | EQUALS | GREATER_THAN_SIGN | QUESTION_MARK | AT_SIGN | ALPHA | OPEN_BRACKET | CLOSED_BRACKET | CIRCUMFLEX_ACCENT | UNDERSCORE | GRAVE_ACCENT | PIPE | TILDE | DOUBLE_DOT | DOUBLE_COLON | PARENT_FOLDER");
        lines.add("DOUBLE_FORWARD_SLASH ::= FORWARD_SLASH FORWARD_SLASH");
        lines.add("BLOCK_COMMENT_START::= FORWARD_SLASH ASTERISK");
        lines.add("BLOCK_COMMENT_END ::= ASTERISK FORWARD_SLASH");
        lines.add("BLOCK_COMMENT_BODY ::= <<blockComment COMCHAR*>>");
        lines.add("BLOCK_COMMENT ::= BLOCK_COMMENT_START BLOCK_COMMENT_BODY BLOCK_COMMENT_END");
    ...
    private static List<String> allowComments(List<String> lines) {
        ...
        result.add("");
        result.add("BLOCK_COMMENT_BODY ::= <<blockComment COMCHAR*>>");
