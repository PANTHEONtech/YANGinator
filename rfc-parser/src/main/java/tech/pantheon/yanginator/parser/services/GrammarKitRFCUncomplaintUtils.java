...
public class GrammarKitRFCUncomplaintUtils {
    ...
    private static List<String> rewriteIdentifier(List<String> lines) {
        ...
        for (String line : lines) {
            if (found) {
                line = "(string-splitter? (or-keyword | and-keyword | not-keyword)? (ALPHA | DIGIT | DATE | ALPHANUMERICAL_ALPHA_FIRST | ALPHANUMERICAL_DIGIT_FIRST | FRACTIONS | DIGITS | UNDERSCORE | DASH | DOT))*";
                found = false;
            }
