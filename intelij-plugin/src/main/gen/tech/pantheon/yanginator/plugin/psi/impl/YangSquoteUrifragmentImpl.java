...
public class YangSquoteUrifragmentImpl extends YangNamedElementImpl implements YangSquoteUrifragment {

    public YangSquoteUrifragmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitSquoteUrifragment(this);
    }
