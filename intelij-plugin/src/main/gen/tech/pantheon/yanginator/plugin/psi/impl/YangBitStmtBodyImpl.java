...
public class YangBitStmtBodyImpl extends YangNamedElementImpl implements YangBitStmtBody {

  public YangBitStmtBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull YangVisitor visitor) {
    visitor.visitBitStmtBody(this);
  }
