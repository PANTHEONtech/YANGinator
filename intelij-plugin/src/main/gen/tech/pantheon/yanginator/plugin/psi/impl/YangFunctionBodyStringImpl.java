...
public class YangFunctionBodyStringImpl extends YangNamedElementImpl implements YangFunctionBodyString {

    public YangFunctionBodyStringImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitFunctionBodyString(this);
    }
