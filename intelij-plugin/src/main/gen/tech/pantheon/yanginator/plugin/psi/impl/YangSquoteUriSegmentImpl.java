...
public class YangSquoteUriSegmentImpl extends YangNamedElementImpl implements YangSquoteUriSegment {

    public YangSquoteUriSegmentImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitSquoteUriSegment(this);
    }
