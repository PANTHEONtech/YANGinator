...
public class YangSquoteUriPcharImpl extends YangNamedElementImpl implements YangSquoteUriPchar {

    public YangSquoteUriPcharImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitSquoteUriPchar(this);
    }
    ...
    @Override
    @Nullable
    public YangSquoteUriSubDelims getSquoteUriSubDelims() {
        return findChildByClass(YangSquoteUriSubDelims.class);
    }
