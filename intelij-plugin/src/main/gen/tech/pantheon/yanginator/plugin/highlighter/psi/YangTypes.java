...
import tech.pantheon.yanginator.plugin.highlighter.psi.impl.YangDummyImpl;
import tech.pantheon.yanginator.plugin.highlighter.psi.impl.YangHAnyTokenImpl;
import tech.pantheon.yanginator.plugin.highlighter.psi.impl.YangHIdentifierLiteralImpl;
import tech.pantheon.yanginator.plugin.highlighter.psi.impl.YangStmtImpl;
import tech.pantheon.yanginator.plugin.highlighter.psi.impl.YangWspImpl;
...
public interface YangTypes {
    ...
    IElementType YANG_H_DIGIT = new YangTokenType("H_DIGIT");
