...
public class YangFunctionBodyNodeStringImpl extends YangNamedElementImpl implements YangFunctionBodyNodeString {

    public YangFunctionBodyNodeStringImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitFunctionBodyNodeString(this);
    }
    ...
    @Override
    @NotNull
    public YangFunctionBodyString getFunctionBodyString() {
        return findNotNullChildByClass(YangFunctionBodyString.class);
    }
