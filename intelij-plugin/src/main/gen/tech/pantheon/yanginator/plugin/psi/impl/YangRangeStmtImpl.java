...
public class YangRangeStmtImpl extends YangStatementImpl implements YangRangeStmt {
  ...
  @Override
  @NotNull
  public List<YangRangeStmtBody> getRangeStmtBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YangRangeStmtBody.class);
  }
  ...
  public PsiElement getRangeKeyword() {
    return findNotNullChildByType(YANG_RANGE_KEYWORD);
  }
