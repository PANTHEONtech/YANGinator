...
import tech.pantheon.yanginator.plugin.psi.impl.YangAbsoluteSchemaNodeidQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangAnyxmlStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangAugmentArgQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangAugmentArgStrImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangAugmentStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangBitStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangCaseStmtBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangCaseStmtImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangChoiceStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangContainerStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangDateArgQuotedImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangEnumStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangExtensionStmtBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangExtensionStmtImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangFeatureStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangGroupingStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangHIdentifierLiteralImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangHexdigImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangHierPartImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangHighlighterTokensImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierArgQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierLiteralImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierRefArgImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentifierRefArgQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangIdentityStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangInputStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangLeafListStmtBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLeafListStmtImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLeafStmtBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLeafStmtImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLeafrefSpecificationBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangLengthStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangLineCommentImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLinkageStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangLinkageStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangListStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangMetaStmtsBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangModuleHeaderStmtsBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangMustStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangNewLineCharactersImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNodeIdentifierImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNodeIdentifierQuotedImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNonNegativeIntegerValueImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNonQuotedStringImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNonZeroDigitImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangNotificationStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangOptsepImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangOutputStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangPatternStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangPredicateExprImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangPredicateImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangPrefixArgImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangPrefixArgQuotedImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangRangeStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineAnyxmlStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineAnyxmlStmtsImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineCaseStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineCaseStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineChoiceStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineChoiceStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineContainerStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineContainerStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineLeafListStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineLeafListStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineLeafStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineLeafStmtsImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineListStmtsBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangRefineListStmtsImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangRpcStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangSingleLineCharactersImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangSingleQuoteStringSplitterImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangSingleQuotedStringBodyCharactersImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangSpImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangSplittedCurrentKeywordImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangStatementImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangStmtsepImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangStringImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangStringRestrictionsBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangSubmoduleHeaderStmtsBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangTokensImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangTypedefStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangUnknownStatement2Impl;
import tech.pantheon.yanginator.plugin.psi.impl.YangUnknownStatementImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangUnquotedStringBodyCharactersImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangUnquotedVcharImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangUsesAugmentStmtBodyImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangUsesAugmentStmtImpl;
import tech.pantheon.yanginator.plugin.psi.impl.YangUsesStmtBodyImpl;
...
import tech.pantheon.yanginator.plugin.psi.impl.YangWhenStmtBodyImpl;
...
public interface YangTypes {
  ...
  IElementType YANG_ABSOLUTE_SCHEMA_NODEID_QUOTED = new YangElementType("YANG_ABSOLUTE_SCHEMA_NODEID_QUOTED");
  IElementType YANG_ANYXML_STMT = new YangElementType("YANG_ANYXML_STMT");
  IElementType YANG_ANYXML_STMT_BODY = new YangElementType("YANG_ANYXML_STMT_BODY");
  ...
  IElementType YANG_AUGMENT_ARG_QUOTED = new YangElementType("YANG_AUGMENT_ARG_QUOTED");
  ...
  IElementType YANG_AUGMENT_STMT_BODY = new YangElementType("YANG_AUGMENT_STMT_BODY");
  ...
  IElementType YANG_BIT_STMT_BODY = new YangElementType("YANG_BIT_STMT_BODY");
  ...
  IElementType YANG_CASE_STMT_BODY = new YangElementType("YANG_CASE_STMT_BODY");
  IElementType YANG_CHOICE_STMT = new YangElementType("YANG_CHOICE_STMT");
  IElementType YANG_CHOICE_STMT_BODY = new YangElementType("YANG_CHOICE_STMT_BODY");
  ...
  IElementType YANG_CONTAINER_STMT_BODY = new YangElementType("YANG_CONTAINER_STMT_BODY");
  ...
  IElementType YANG_DATE_ARG_QUOTED = new YangElementType("YANG_DATE_ARG_QUOTED");
  ...
  IElementType YANG_ENUM_STMT_BODY = new YangElementType("YANG_ENUM_STMT_BODY");
  ...
  IElementType YANG_EXTENSION_STMT_BODY = new YangElementType("YANG_EXTENSION_STMT_BODY");
  IElementType YANG_FEATURE_STMT = new YangElementType("YANG_FEATURE_STMT");
  IElementType YANG_FEATURE_STMT_BODY = new YangElementType("YANG_FEATURE_STMT_BODY");
  ...
  IElementType YANG_GROUPING_STMT_BODY = new YangElementType("YANG_GROUPING_STMT_BODY");
  IElementType YANG_HEXDIG = new YangElementType("YANG_HEXDIG");
  IElementType YANG_HIER_PART = new YangElementType("YANG_HIER_PART");
  IElementType YANG_HIGHLIGHTER_TOKENS = new YangElementType("YANG_HIGHLIGHTER_TOKENS");
  ...
  IElementType YANG_IDENTIFIER_ARG_QUOTED = new YangElementType("YANG_IDENTIFIER_ARG_QUOTED");
  IElementType YANG_IDENTIFIER_LITERAL = new YangElementType("YANG_IDENTIFIER_LITERAL");
  IElementType YANG_IDENTIFIER_QUOTED = new YangElementType("YANG_IDENTIFIER_QUOTED");
  IElementType YANG_IDENTIFIER_REF_ARG = new YangElementType("YANG_IDENTIFIER_REF_ARG");
  IElementType YANG_IDENTIFIER_REF_ARG_QUOTED = new YangElementType("YANG_IDENTIFIER_REF_ARG_QUOTED");
  ...
  IElementType YANG_IDENTITY_STMT_BODY = new YangElementType("YANG_IDENTITY_STMT_BODY");
  ...
  IElementType YANG_INPUT_STMT_BODY = new YangElementType("YANG_INPUT_STMT_BODY");
  ...
  IElementType YANG_LEAFREF_SPECIFICATION_BODY = new YangElementType("YANG_LEAFREF_SPECIFICATION_BODY");
  IElementType YANG_LEAF_LIST_STMT = new YangElementType("YANG_LEAF_LIST_STMT");
  IElementType YANG_LEAF_LIST_STMT_BODY = new YangElementType("YANG_LEAF_LIST_STMT_BODY");
  IElementType YANG_LEAF_STMT = new YangElementType("YANG_LEAF_STMT");
  IElementType YANG_LEAF_STMT_BODY = new YangElementType("YANG_LEAF_STMT_BODY");
  ...
  IElementType YANG_LENGTH_STMT_BODY = new YangElementType("YANG_LENGTH_STMT_BODY");
  IElementType YANG_LF = new YangElementType("YANG_LF");
  IElementType YANG_LINE_BREAK = new YangElementType("YANG_LINE_BREAK");
  IElementType YANG_LINE_COMMENT = new YangElementType("YANG_LINE_COMMENT");
  IElementType YANG_LINKAGE_STMTS = new YangElementType("YANG_LINKAGE_STMTS");
  IElementType YANG_LINKAGE_STMTS_BODY = new YangElementType("YANG_LINKAGE_STMTS_BODY");
  IElementType YANG_LIST_STMT = new YangElementType("YANG_LIST_STMT");
  IElementType YANG_LIST_STMT_BODY = new YangElementType("YANG_LIST_STMT_BODY");
  ...
  IElementType YANG_META_STMTS_BODY = new YangElementType("YANG_META_STMTS_BODY");
  ...
  IElementType YANG_MODULE_HEADER_STMTS_BODY = new YangElementType("YANG_MODULE_HEADER_STMTS_BODY");
  ...
  IElementType YANG_MUST_STMT_BODY = new YangElementType("YANG_MUST_STMT_BODY");
  IElementType YANG_NAMESPACE_STMT = new YangElementType("YANG_NAMESPACE_STMT");
  IElementType YANG_NEW_LINE_CHARACTERS = new YangElementType("YANG_NEW_LINE_CHARACTERS");
  IElementType YANG_NODE_IDENTIFIER = new YangElementType("YANG_NODE_IDENTIFIER");
  IElementType YANG_NODE_IDENTIFIER_QUOTED = new YangElementType("YANG_NODE_IDENTIFIER_QUOTED");
  IElementType YANG_NON_NEGATIVE_INTEGER_VALUE = new YangElementType("YANG_NON_NEGATIVE_INTEGER_VALUE");
  IElementType YANG_NON_QUOTED_STRING = new YangElementType("YANG_NON_QUOTED_STRING");
  ...
  IElementType YANG_NOTIFICATION_STMT_BODY = new YangElementType("YANG_NOTIFICATION_STMT_BODY");
  ...
  IElementType YANG_OUTPUT_STMT_BODY = new YangElementType("YANG_OUTPUT_STMT_BODY");
  ...
  IElementType YANG_PATTERN_STMT_BODY = new YangElementType("YANG_PATTERN_STMT_BODY");
  ...
  IElementType YANG_PREDICATE = new YangElementType("YANG_PREDICATE");
  IElementType YANG_PREDICATE_EXPR = new YangElementType("YANG_PREDICATE_EXPR");
  IElementType YANG_PREFIX = new YangElementType("YANG_PREFIX");
  IElementType YANG_PREFIX_ARG = new YangElementType("YANG_PREFIX_ARG");
  IElementType YANG_PREFIX_ARG_QUOTED = new YangElementType("YANG_PREFIX_ARG_QUOTED");
  ...
  IElementType YANG_RANGE_STMT_BODY = new YangElementType("YANG_RANGE_STMT_BODY");
  ...
  IElementType YANG_REFINE_ANYXML_STMTS_BODY = new YangElementType("YANG_REFINE_ANYXML_STMTS_BODY");
  ...
  IElementType YANG_REFINE_CASE_STMTS_BODY = new YangElementType("YANG_REFINE_CASE_STMTS_BODY");
  IElementType YANG_REFINE_CHOICE_STMTS = new YangElementType("YANG_REFINE_CHOICE_STMTS");
  IElementType YANG_REFINE_CHOICE_STMTS_BODY = new YangElementType("YANG_REFINE_CHOICE_STMTS_BODY");
  IElementType YANG_REFINE_CONTAINER_STMTS = new YangElementType("YANG_REFINE_CONTAINER_STMTS");
  IElementType YANG_REFINE_CONTAINER_STMTS_BODY = new YangElementType("YANG_REFINE_CONTAINER_STMTS_BODY");
  IElementType YANG_REFINE_LEAF_LIST_STMTS = new YangElementType("YANG_REFINE_LEAF_LIST_STMTS");
  IElementType YANG_REFINE_LEAF_LIST_STMTS_BODY = new YangElementType("YANG_REFINE_LEAF_LIST_STMTS_BODY");
  IElementType YANG_REFINE_LEAF_STMTS = new YangElementType("YANG_REFINE_LEAF_STMTS");
  IElementType YANG_REFINE_LEAF_STMTS_BODY = new YangElementType("YANG_REFINE_LEAF_STMTS_BODY");
  IElementType YANG_REFINE_LIST_STMTS = new YangElementType("YANG_REFINE_LIST_STMTS");
  IElementType YANG_REFINE_LIST_STMTS_BODY = new YangElementType("YANG_REFINE_LIST_STMTS_BODY");
  ...
  IElementType YANG_RPC_STMT_BODY = new YangElementType("YANG_RPC_STMT_BODY");
  ...
  IElementType YANG_SINGLE_LINE_CHARACTERS = new YangElementType("YANG_SINGLE_LINE_CHARACTERS");
  IElementType YANG_SINGLE_QUOTED_STRING_BODY_CHARACTERS = new YangElementType("YANG_SINGLE_QUOTED_STRING_BODY_CHARACTERS");
  IElementType YANG_SINGLE_QUOTE_STRING_SPLITTER = new YangElementType("YANG_SINGLE_QUOTE_STRING_SPLITTER");
  IElementType YANG_SP = new YangElementType("YANG_SP");
  IElementType YANG_SPLITTED_CURRENT_KEYWORD = new YangElementType("YANG_SPLITTED_CURRENT_KEYWORD");
  ...
  IElementType YANG_STRING_RESTRICTIONS_BODY = new YangElementType("YANG_STRING_RESTRICTIONS_BODY");
  ...
  IElementType YANG_SUBMODULE_HEADER_STMTS_BODY = new YangElementType("YANG_SUBMODULE_HEADER_STMTS_BODY");
  ...
  IElementType YANG_TYPEDEF_STMT_BODY = new YangElementType("YANG_TYPEDEF_STMT_BODY");
  ...
  IElementType YANG_UNQUOTED_STRING_BODY_CHARACTERS = new YangElementType("YANG_UNQUOTED_STRING_BODY_CHARACTERS");
  IElementType YANG_UNQUOTED_VCHAR = new YangElementType("YANG_UNQUOTED_VCHAR");
  ...
  IElementType YANG_USES_AUGMENT_STMT_BODY = new YangElementType("YANG_USES_AUGMENT_STMT_BODY");
  IElementType YANG_USES_STMT = new YangElementType("YANG_USES_STMT");
  IElementType YANG_USES_STMT_BODY = new YangElementType("YANG_USES_STMT_BODY");
  ...
  IElementType YANG_WHEN_STMT_BODY = new YangElementType("YANG_WHEN_STMT_BODY");
  ...
  IElementType YANG_ADD_KEYWORD = new YangTokenType("ADD_KEYWORD");
  ...
  IElementType YANG_BLOCK_COMMENT_END = new YangTokenType("BLOCK_COMMENT_END");
  ...
  IElementType YANG_CURRENT_KEYWORD = new YangTokenType("CURRENT_KEYWORD");
  IElementType YANG_DASH = new YangTokenType("DASH");
  IElementType YANG_DEFAULT_KEYWORD = new YangTokenType("DEFAULT_KEYWORD");
  IElementType YANG_DELETE_KEYWORD = new YangTokenType("DELETE_KEYWORD");
  IElementType YANG_DEPRECATED_KEYWORD = new YangTokenType("DEPRECATED_KEYWORD");
  ...
  IElementType YANG_EQUAL = new YangTokenType("EQUAL");
  ...
  IElementType YANG_FALSE_KEYWORD = new YangTokenType("FALSE_KEYWORD");
  ...
  IElementType YANG_H_A = new YangTokenType("H_A");
  IElementType YANG_H_ADD_KEYWORD = new YangTokenType("H_ADD_KEYWORD");
  IElementType YANG_H_ANYXML_KEYWORD = new YangTokenType("H_ANYXML_KEYWORD");
  IElementType YANG_H_ARGUMENT_KEYWORD = new YangTokenType("H_ARGUMENT_KEYWORD");
  IElementType YANG_H_AUGMENT_KEYWORD = new YangTokenType("H_AUGMENT_KEYWORD");
  IElementType YANG_H_BASE_KEYWORD = new YangTokenType("H_BASE_KEYWORD");
  IElementType YANG_H_BELONGS_TO_KEYWORD = new YangTokenType("H_BELONGS_TO_KEYWORD");
  IElementType YANG_H_BIT_KEYWORD = new YangTokenType("H_BIT_KEYWORD");
  IElementType YANG_H_BLOCK_COMMENT = new YangTokenType("H_BLOCK_COMMENT");
  IElementType YANG_H_CASE_KEYWORD = new YangTokenType("H_CASE_KEYWORD");
  IElementType YANG_H_CHOICE_KEYWORD = new YangTokenType("H_CHOICE_KEYWORD");
  IElementType YANG_H_CONFIG_KEYWORD = new YangTokenType("H_CONFIG_KEYWORD");
  IElementType YANG_H_CONTACT_KEYWORD = new YangTokenType("H_CONTACT_KEYWORD");
  IElementType YANG_H_CONTAINER_KEYWORD = new YangTokenType("H_CONTAINER_KEYWORD");
  IElementType YANG_H_CURRENT_KEYWORD = new YangTokenType("H_CURRENT_KEYWORD");
  IElementType YANG_H_DATE_ARG = new YangTokenType("H_DATE_ARG");
  IElementType YANG_H_DEFAULT_KEYWORD = new YangTokenType("H_DEFAULT_KEYWORD");
  IElementType YANG_H_DELETE_KEYWORD = new YangTokenType("H_DELETE_KEYWORD");
  IElementType YANG_H_DEPRECATED_KEYWORD = new YangTokenType("H_DEPRECATED_KEYWORD");
  IElementType YANG_H_DESCRIPTION_KEYWORD = new YangTokenType("H_DESCRIPTION_KEYWORD");
  IElementType YANG_H_DEVIATE_KEYWORD = new YangTokenType("H_DEVIATE_KEYWORD");
  IElementType YANG_H_DEVIATION_KEYWORD = new YangTokenType("H_DEVIATION_KEYWORD");
  IElementType YANG_H_ENUM_KEYWORD = new YangTokenType("H_ENUM_KEYWORD");
  IElementType YANG_H_ERROR_APP_TAG_KEYWORD = new YangTokenType("H_ERROR_APP_TAG_KEYWORD");
  IElementType YANG_H_ERROR_MESSAGE_KEYWORD = new YangTokenType("H_ERROR_MESSAGE_KEYWORD");
  IElementType YANG_H_EXTENSION_IDENTIFIER = new YangTokenType("H_EXTENSION_IDENTIFIER");
  IElementType YANG_H_EXTENSION_KEYWORD = new YangTokenType("H_EXTENSION_KEYWORD");
  IElementType YANG_H_FALSE_KEYWORD = new YangTokenType("H_FALSE_KEYWORD");
  IElementType YANG_H_FEATURE_KEYWORD = new YangTokenType("H_FEATURE_KEYWORD");
  IElementType YANG_H_FRACTION_DIGITS_KEYWORD = new YangTokenType("H_FRACTION_DIGITS_KEYWORD");
  IElementType YANG_H_FS = new YangTokenType("H_FS");
  IElementType YANG_H_GROUPING_KEYWORD = new YangTokenType("H_GROUPING_KEYWORD");
  IElementType YANG_H_IDENTIFIER = new YangTokenType("H_IDENTIFIER");
  IElementType YANG_H_IDENTITY_KEYWORD = new YangTokenType("H_IDENTITY_KEYWORD");
  IElementType YANG_H_IF_FEATURE_KEYWORD = new YangTokenType("H_IF_FEATURE_KEYWORD");
  IElementType YANG_H_IMPORT_KEYWORD = new YangTokenType("H_IMPORT_KEYWORD");
  IElementType YANG_H_INCLUDE_KEYWORD = new YangTokenType("H_INCLUDE_KEYWORD");
  IElementType YANG_H_INPUT_KEYWORD = new YangTokenType("H_INPUT_KEYWORD");
  IElementType YANG_H_KEY_KEYWORD = new YangTokenType("H_KEY_KEYWORD");
  IElementType YANG_H_LEAF_KEYWORD = new YangTokenType("H_LEAF_KEYWORD");
  IElementType YANG_H_LEAF_LIST_KEYWORD = new YangTokenType("H_LEAF_LIST_KEYWORD");
  IElementType YANG_H_LENGTH_KEYWORD = new YangTokenType("H_LENGTH_KEYWORD");
  IElementType YANG_H_LIST_KEYWORD = new YangTokenType("H_LIST_KEYWORD");
  IElementType YANG_H_MANDATORY_KEYWORD = new YangTokenType("H_MANDATORY_KEYWORD");
  IElementType YANG_H_MAX_ELEMENTS_KEYWORD = new YangTokenType("H_MAX_ELEMENTS_KEYWORD");
  IElementType YANG_H_MAX_KEYWORD = new YangTokenType("H_MAX_KEYWORD");
  IElementType YANG_H_MIN_ELEMENTS_KEYWORD = new YangTokenType("H_MIN_ELEMENTS_KEYWORD");
  IElementType YANG_H_MIN_KEYWORD = new YangTokenType("H_MIN_KEYWORD");
  IElementType YANG_H_MODULE_KEYWORD = new YangTokenType("H_MODULE_KEYWORD");
  IElementType YANG_H_MUST_KEYWORD = new YangTokenType("H_MUST_KEYWORD");
  IElementType YANG_H_NAMESPACE_KEYWORD = new YangTokenType("H_NAMESPACE_KEYWORD");
  IElementType YANG_H_NOTIFICATION_KEYWORD = new YangTokenType("H_NOTIFICATION_KEYWORD");
  IElementType YANG_H_NOT_STRING = new YangTokenType("H_NOT_STRING");
  IElementType YANG_H_NOT_SUPPORTED_KEYWORD = new YangTokenType("H_NOT_SUPPORTED_KEYWORD");
  IElementType YANG_H_OBSOLETE_KEYWORD = new YangTokenType("H_OBSOLETE_KEYWORD");
  IElementType YANG_H_ORDERED_BY_KEYWORD = new YangTokenType("H_ORDERED_BY_KEYWORD");
  IElementType YANG_H_ORGANIZATION_KEYWORD = new YangTokenType("H_ORGANIZATION_KEYWORD");
  IElementType YANG_H_OUTPUT_KEYWORD = new YangTokenType("H_OUTPUT_KEYWORD");
  IElementType YANG_H_PATH_KEYWORD = new YangTokenType("H_PATH_KEYWORD");
  IElementType YANG_H_PATTERN_KEYWORD = new YangTokenType("H_PATTERN_KEYWORD");
  IElementType YANG_H_POSITION_KEYWORD = new YangTokenType("H_POSITION_KEYWORD");
  IElementType YANG_H_PREFIX_KEYWORD = new YangTokenType("H_PREFIX_KEYWORD");
  IElementType YANG_H_PRESENCE_KEYWORD = new YangTokenType("H_PRESENCE_KEYWORD");
  IElementType YANG_H_RANGE_KEYWORD = new YangTokenType("H_RANGE_KEYWORD");
  IElementType YANG_H_REFERENCE_KEYWORD = new YangTokenType("H_REFERENCE_KEYWORD");
  IElementType YANG_H_REFINE_KEYWORD = new YangTokenType("H_REFINE_KEYWORD");
  IElementType YANG_H_REPLACE_KEYWORD = new YangTokenType("H_REPLACE_KEYWORD");
  IElementType YANG_H_REQUIRE_INSTANCE_KEYWORD = new YangTokenType("H_REQUIRE_INSTANCE_KEYWORD");
  IElementType YANG_H_REVISION_DATE_KEYWORD = new YangTokenType("H_REVISION_DATE_KEYWORD");
  IElementType YANG_H_REVISION_KEYWORD = new YangTokenType("H_REVISION_KEYWORD");
  IElementType YANG_H_RPC_KEYWORD = new YangTokenType("H_RPC_KEYWORD");
  IElementType YANG_H_SEMICOLON = new YangTokenType("H_SEMICOLON");
  IElementType YANG_H_SINGLE_LINE_COMMENT = new YangTokenType("H_SINGLE_LINE_COMMENT");
  IElementType YANG_H_STATUS_KEYWORD = new YangTokenType("H_STATUS_KEYWORD");
  IElementType YANG_H_STRING = new YangTokenType("H_STRING");
  IElementType YANG_H_SUBMODULE_KEYWORD = new YangTokenType("H_SUBMODULE_KEYWORD");
  IElementType YANG_H_SYSTEM_KEYWORD = new YangTokenType("H_SYSTEM_KEYWORD");
  IElementType YANG_H_TRUE_KEYWORD = new YangTokenType("H_TRUE_KEYWORD");
  IElementType YANG_H_TYPEDEF_KEYWORD = new YangTokenType("H_TYPEDEF_KEYWORD");
  IElementType YANG_H_TYPE_KEYWORD = new YangTokenType("H_TYPE_KEYWORD");
  IElementType YANG_H_UNBOUNDED_KEYWORD = new YangTokenType("H_UNBOUNDED_KEYWORD");
  IElementType YANG_H_UNIQUE_KEYWORD = new YangTokenType("H_UNIQUE_KEYWORD");
  IElementType YANG_H_UNITS_KEYWORD = new YangTokenType("H_UNITS_KEYWORD");
  IElementType YANG_H_USER_KEYWORD = new YangTokenType("H_USER_KEYWORD");
  IElementType YANG_H_USES_KEYWORD = new YangTokenType("H_USES_KEYWORD");
  IElementType YANG_H_VALUE_KEYWORD = new YangTokenType("H_VALUE_KEYWORD");
  IElementType YANG_H_WHEN_KEYWORD = new YangTokenType("H_WHEN_KEYWORD");
  IElementType YANG_H_WHITE_SPACE = new YangTokenType("H_WHITE_SPACE");
  IElementType YANG_H_YANG_VERSION_KEYWORD = new YangTokenType("H_YANG_VERSION_KEYWORD");
  IElementType YANG_H_YIN_ELEMENT_KEYWORD = new YangTokenType("H_YIN_ELEMENT_KEYWORD");
  ...
  IElementType YANG_MAX_KEYWORD = new YangTokenType("MAX_KEYWORD");
  IElementType YANG_MIN_ELEMENTS_KEYWORD = new YangTokenType("MIN_ELEMENTS_KEYWORD");
  IElementType YANG_MIN_KEYWORD = new YangTokenType("MIN_KEYWORD");
  ...
  IElementType YANG_NOT_SUPPORTED_KEYWORD = new YangTokenType("NOT_SUPPORTED_KEYWORD");
  IElementType YANG_OBSOLETE_KEYWORD = new YangTokenType("OBSOLETE_KEYWORD");
  ...
  IElementType YANG_OTHER_CHARACTER = new YangTokenType("OTHER_CHARACTER");
  ...
  IElementType YANG_REPLACE_KEYWORD = new YangTokenType("REPLACE_KEYWORD");
  ...
  IElementType YANG_SINGLE_LINE_COMMENT_START = new YangTokenType("SINGLE_LINE_COMMENT_START");
  ...
  IElementType YANG_STRINGS_DOUBLE_QUOTE = new YangTokenType("STRINGS_DOUBLE_QUOTE");
  IElementType YANG_STRINGS_SINGLE_QUOTE = new YangTokenType("STRINGS_SINGLE_QUOTE");
  IElementType YANG_SUBMODULE_KEYWORD = new YangTokenType("SUBMODULE_KEYWORD");
  IElementType YANG_SYSTEM_KEYWORD = new YangTokenType("SYSTEM_KEYWORD");
  IElementType YANG_TAB = new YangTokenType("TAB");
  IElementType YANG_TRUE_KEYWORD = new YangTokenType("TRUE_KEYWORD");
  ...
  IElementType YANG_UNBOUNDED_KEYWORD = new YangTokenType("UNBOUNDED_KEYWORD");
  ...
  IElementType YANG_USER_KEYWORD = new YangTokenType("USER_KEYWORD");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      else if (type == YANG_ABSOLUTE_SCHEMA_NODEID_QUOTED) {
        return new YangAbsoluteSchemaNodeidQuotedImpl(node);
      }
      else if (type == YANG_ANYXML_STMT) {
        return new YangAnyxmlStmtImpl(node);
      }
      else if (type == YANG_ANYXML_STMT_BODY) {
        return new YangAnyxmlStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_AUGMENT_ARG_QUOTED) {
        return new YangAugmentArgQuotedImpl(node);
      }
      ...
      else if (type == YANG_AUGMENT_STMT_BODY) {
        return new YangAugmentStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_BIT_STMT_BODY) {
        return new YangBitStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_CASE_STMT_BODY) {
        return new YangCaseStmtBodyImpl(node);
      }
      else if (type == YANG_CHOICE_STMT) {
        return new YangChoiceStmtImpl(node);
      }
      else if (type == YANG_CHOICE_STMT_BODY) {
        return new YangChoiceStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_CONTAINER_STMT_BODY) {
        return new YangContainerStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_DATE_ARG_QUOTED) {
        return new YangDateArgQuotedImpl(node);
      }
      ...
      else if (type == YANG_ENUM_STMT_BODY) {
        return new YangEnumStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_EXTENSION_STMT_BODY) {
        return new YangExtensionStmtBodyImpl(node);
      }
      else if (type == YANG_FEATURE_STMT) {
        return new YangFeatureStmtImpl(node);
      }
      else if (type == YANG_FEATURE_STMT_BODY) {
        return new YangFeatureStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_GROUPING_STMT_BODY) {
        return new YangGroupingStmtBodyImpl(node);
      }
      else if (type == YANG_HEXDIG) {
        return new YangHexdigImpl(node);
      }
      else if (type == YANG_HIER_PART) {
        return new YangHierPartImpl(node);
      }
      else if (type == YANG_HIGHLIGHTER_TOKENS) {
        return new YangHighlighterTokensImpl(node);
      }
      ...
      else if (type == YANG_IDENTIFIER_ARG_QUOTED) {
        return new YangIdentifierArgQuotedImpl(node);
      }
      else if (type == YANG_IDENTIFIER_LITERAL) {
        return new YangIdentifierLiteralImpl(node);
      }
      else if (type == YANG_IDENTIFIER_QUOTED) {
        return new YangIdentifierQuotedImpl(node);
      }
      else if (type == YANG_IDENTIFIER_REF_ARG) {
        return new YangIdentifierRefArgImpl(node);
      }
      else if (type == YANG_IDENTIFIER_REF_ARG_QUOTED) {
        return new YangIdentifierRefArgQuotedImpl(node);
      }
      ...
      else if (type == YANG_IDENTITY_STMT_BODY) {
        return new YangIdentityStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_INPUT_STMT_BODY) {
        return new YangInputStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_LEAFREF_SPECIFICATION_BODY) {
        return new YangLeafrefSpecificationBodyImpl(node);
      }
      else if (type == YANG_LEAF_LIST_STMT) {
        return new YangLeafListStmtImpl(node);
      }
      else if (type == YANG_LEAF_LIST_STMT_BODY) {
        return new YangLeafListStmtBodyImpl(node);
      }
      else if (type == YANG_LEAF_STMT) {
        return new YangLeafStmtImpl(node);
      }
      else if (type == YANG_LEAF_STMT_BODY) {
        return new YangLeafStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_LENGTH_STMT_BODY) {
        return new YangLengthStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_LINE_COMMENT) {
        return new YangLineCommentImpl(node);
      }
      else if (type == YANG_LINKAGE_STMTS) {
        return new YangLinkageStmtsImpl(node);
      }
      else if (type == YANG_LINKAGE_STMTS_BODY) {
        return new YangLinkageStmtsBodyImpl(node);
      }
      else if (type == YANG_LIST_STMT) {
        return new YangListStmtImpl(node);
      }
      else if (type == YANG_LIST_STMT_BODY) {
        return new YangListStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_META_STMTS_BODY) {
        return new YangMetaStmtsBodyImpl(node);
      }
      ...
      else if (type == YANG_MODULE_HEADER_STMTS_BODY) {
        return new YangModuleHeaderStmtsBodyImpl(node);
      }
      ...
      else if (type == YANG_MUST_STMT_BODY) {
        return new YangMustStmtBodyImpl(node);
      }
      else if (type == YANG_NAMESPACE_STMT) {
        return new YangNamespaceStmtImpl(node);
      }
      else if (type == YANG_NEW_LINE_CHARACTERS) {
        return new YangNewLineCharactersImpl(node);
      }
      else if (type == YANG_NODE_IDENTIFIER) {
        return new YangNodeIdentifierImpl(node);
      }
      else if (type == YANG_NODE_IDENTIFIER_QUOTED) {
        return new YangNodeIdentifierQuotedImpl(node);
      }
      else if (type == YANG_NON_NEGATIVE_INTEGER_VALUE) {
        return new YangNonNegativeIntegerValueImpl(node);
      }
      else if (type == YANG_NON_QUOTED_STRING) {
        return new YangNonQuotedStringImpl(node);
      }
      ...
      else if (type == YANG_NOTIFICATION_STMT_BODY) {
        return new YangNotificationStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_OUTPUT_STMT_BODY) {
        return new YangOutputStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_PATTERN_STMT_BODY) {
        return new YangPatternStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_PREDICATE) {
        return new YangPredicateImpl(node);
      }
      else if (type == YANG_PREDICATE_EXPR) {
        return new YangPredicateExprImpl(node);
      }
      ...
      else if (type == YANG_PREFIX_ARG_QUOTED) {
        return new YangPrefixArgQuotedImpl(node);
      }
      else if (type == YANG_PREFIX_ARG_STR) {
        return new YangPrefixArgStrImpl(node);
      }
      else if (type == YANG_PREFIX_QUOTED) {
        return new YangPrefixQuotedImpl(node);
      }
      ...
      else if (type == YANG_QUOTED_STRING_BODY_CHARACTERS) {
        return new YangQuotedStringBodyCharactersImpl(node);
      }
      ...
      else if (type == YANG_RANGE_STMT_BODY) {
        return new YangRangeStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_REFINE_ANYXML_STMTS_BODY) {
        return new YangRefineAnyxmlStmtsBodyImpl(node);
      }
      ...
      else if (type == YANG_REFINE_CASE_STMTS_BODY) {
        return new YangRefineCaseStmtsBodyImpl(node);
      }
      else if (type == YANG_REFINE_CHOICE_STMTS) {
        return new YangRefineChoiceStmtsImpl(node);
      }
      else if (type == YANG_REFINE_CHOICE_STMTS_BODY) {
        return new YangRefineChoiceStmtsBodyImpl(node);
      }
      else if (type == YANG_REFINE_CONTAINER_STMTS) {
        return new YangRefineContainerStmtsImpl(node);
      }
      else if (type == YANG_REFINE_CONTAINER_STMTS_BODY) {
        return new YangRefineContainerStmtsBodyImpl(node);
      }
      else if (type == YANG_REFINE_LEAF_LIST_STMTS) {
        return new YangRefineLeafListStmtsImpl(node);
      }
      else if (type == YANG_REFINE_LEAF_LIST_STMTS_BODY) {
        return new YangRefineLeafListStmtsBodyImpl(node);
      }
      else if (type == YANG_REFINE_LEAF_STMTS) {
        return new YangRefineLeafStmtsImpl(node);
      }
      else if (type == YANG_REFINE_LEAF_STMTS_BODY) {
        return new YangRefineLeafStmtsBodyImpl(node);
      }
      else if (type == YANG_REFINE_LIST_STMTS) {
        return new YangRefineListStmtsImpl(node);
      }
      else if (type == YANG_REFINE_LIST_STMTS_BODY) {
        return new YangRefineListStmtsBodyImpl(node);
      }
      ...
      else if (type == YANG_RPC_STMT_BODY) {
        return new YangRpcStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_SINGLE_LINE_CHARACTERS) {
        return new YangSingleLineCharactersImpl(node);
      }
      else if (type == YANG_SINGLE_QUOTED_STRING_BODY_CHARACTERS) {
        return new YangSingleQuotedStringBodyCharactersImpl(node);
      }
      else if (type == YANG_SINGLE_QUOTE_STRING_SPLITTER) {
        return new YangSingleQuoteStringSplitterImpl(node);
      }
      else if (type == YANG_SP) {
        return new YangSpImpl(node);
      }
      else if (type == YANG_SPLITTED_CURRENT_KEYWORD) {
        return new YangSplittedCurrentKeywordImpl(node);
      }
      ...
      else if (type == YANG_STRING_RESTRICTIONS_BODY) {
        return new YangStringRestrictionsBodyImpl(node);
      }
      ...
      else if (type == YANG_SUBMODULE_HEADER_STMTS_BODY) {
        return new YangSubmoduleHeaderStmtsBodyImpl(node);
      }
      ...
      else if (type == YANG_TYPEDEF_STMT_BODY) {
        return new YangTypedefStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_UNQUOTED_STRING_BODY_CHARACTERS) {
        return new YangUnquotedStringBodyCharactersImpl(node);
      }
      else if (type == YANG_UNQUOTED_VCHAR) {
        return new YangUnquotedVcharImpl(node);
      }
      ...
      else if (type == YANG_USES_AUGMENT_STMT_BODY) {
        return new YangUsesAugmentStmtBodyImpl(node);
      }
      else if (type == YANG_USES_STMT) {
        return new YangUsesStmtImpl(node);
      }
      else if (type == YANG_USES_STMT_BODY) {
        return new YangUsesStmtBodyImpl(node);
      }
      ...
      else if (type == YANG_WHEN_STMT_BODY) {
        return new YangWhenStmtBodyImpl(node);
      }
