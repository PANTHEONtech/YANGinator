...
public class YangPatternBodyImpl extends YangNamedElementImpl implements YangPatternBody {

    public YangPatternBodyImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitPatternBody(this);
    }
