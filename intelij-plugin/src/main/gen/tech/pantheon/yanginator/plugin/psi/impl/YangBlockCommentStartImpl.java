...
public class YangBlockCommentStartImpl extends YangNamedElementImpl implements YangBlockCommentStart {

    public YangBlockCommentStartImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitBlockCommentStart(this);
    }
    ...
    public PsiElement getAsterisk() {
        return findNotNullChildByType(YANG_ASTERISK);
    }
