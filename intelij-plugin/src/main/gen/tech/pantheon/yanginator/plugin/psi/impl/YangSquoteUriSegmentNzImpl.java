...
public class YangSquoteUriSegmentNzImpl extends YangNamedElementImpl implements YangSquoteUriSegmentNz {

    public YangSquoteUriSegmentNzImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitSquoteUriSegmentNz(this);
    }
