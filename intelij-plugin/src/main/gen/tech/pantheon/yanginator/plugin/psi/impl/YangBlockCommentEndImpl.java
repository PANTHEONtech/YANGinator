...
public class YangBlockCommentEndImpl extends YangNamedElementImpl implements YangBlockCommentEnd {

    public YangBlockCommentEndImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitBlockCommentEnd(this);
    }
