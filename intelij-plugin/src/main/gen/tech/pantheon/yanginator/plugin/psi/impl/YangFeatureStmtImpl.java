...
public class YangFeatureStmtImpl extends YangStatementImpl implements YangFeatureStmt {
  ...
  @Override
  @NotNull
  public List<YangFeatureStmtBody> getFeatureStmtBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YangFeatureStmtBody.class);
  }
  ...
  public PsiElement getFeatureKeyword() {
    return findNotNullChildByType(YANG_FEATURE_KEYWORD);
  }
