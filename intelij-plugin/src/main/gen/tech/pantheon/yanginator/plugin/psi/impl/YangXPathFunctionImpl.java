...
public class YangXPathFunctionImpl extends YangNamedElementImpl implements YangXPathFunction {

    public YangXPathFunctionImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public YangFunction getFunction() {
        return findNotNullChildByClass(YangFunction.class);
    }
