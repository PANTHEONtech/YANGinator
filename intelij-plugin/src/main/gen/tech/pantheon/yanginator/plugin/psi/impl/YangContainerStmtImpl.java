...
public class YangContainerStmtImpl extends YangStatementImpl implements YangContainerStmt {
  ...
  @Override
  @NotNull
  public List<YangContainerStmtBody> getContainerStmtBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YangContainerStmtBody.class);
  }
  ...
  public PsiElement getContainerKeyword() {
    return findNotNullChildByType(YANG_CONTAINER_KEYWORD);
  }
