...
public class YangSquoteUriSubDelimsImpl extends YangNamedElementImpl implements YangSquoteUriSubDelims {

    public YangSquoteUriSubDelimsImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitSquoteUriSubDelims(this);
    }
