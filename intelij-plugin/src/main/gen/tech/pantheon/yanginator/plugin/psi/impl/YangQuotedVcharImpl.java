...
public class YangQuotedVcharImpl extends YangNamedElementImpl implements YangQuotedVchar {

    public YangQuotedVcharImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull YangVisitor visitor) {
        visitor.visitQuotedVchar(this);
    }
