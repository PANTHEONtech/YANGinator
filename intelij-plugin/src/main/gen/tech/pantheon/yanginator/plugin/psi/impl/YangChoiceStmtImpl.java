...
public class YangChoiceStmtImpl extends YangStatementImpl implements YangChoiceStmt {
  ...
  @Override
  @NotNull
  public List<YangChoiceStmtBody> getChoiceStmtBodyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, YangChoiceStmtBody.class);
  }
  ...
  public PsiElement getChoiceKeyword() {
    return findNotNullChildByType(YANG_CHOICE_KEYWORD);
  }
