...
public class YangMetaStmtsCheck extends AbstractYangStmtCheck {
    @Override
    ...
    public void performCheck(@NotNull final PsiElement element, @NotNull final AnnotationHolder holder) {
        maxOne.check(element, holder, YangOrganizationStmt.class);
        maxOne.check(element, holder, YangContactStmt.class);
