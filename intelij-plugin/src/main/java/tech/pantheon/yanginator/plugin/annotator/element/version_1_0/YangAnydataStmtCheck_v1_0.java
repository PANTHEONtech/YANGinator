...
public class YangAnydataStmtCheck_v1_0 extends AbstractYangStmtCheck {
    @Override
    ...
    public void performCheck(@NotNull final PsiElement element, @NotNull final AnnotationHolder holder) {
        holder.newAnnotation(HighlightSeverity.ERROR, "Anydata statement is not allowed in yang 1.0")
