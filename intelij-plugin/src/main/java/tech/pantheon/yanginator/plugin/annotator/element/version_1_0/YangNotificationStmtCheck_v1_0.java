...
public class YangNotificationStmtCheck_v1_0 extends AbstractYangStmtCheck {
    @Override
    ...
    public void performCheck(@NotNull final PsiElement element, @NotNull final AnnotationHolder holder) {
        ...
        if (!(element.getParent() instanceof YangBodyStmts)) {
            holder.newAnnotation(HighlightSeverity.ERROR, "Notification statement" +
                            " is only allowed in body statements yang 1.0")
