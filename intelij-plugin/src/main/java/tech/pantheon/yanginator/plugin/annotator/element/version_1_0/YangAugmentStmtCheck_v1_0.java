...
public class YangAugmentStmtCheck_v1_0 extends AbstractYangStmtCheck {
    @Override
    ...
    public void performCheck(@NotNull final PsiElement element, @NotNull final AnnotationHolder holder) {
        maxZero.check(element, holder, YangActionStmt.class);
        maxZero.check(element, holder, YangNotificationStmt.class);
    }
}
