...
public class YangDecimal64SpecificationCheck extends AbstractYangStmtCheck {
    @Override
    public boolean isApplicable(@NotNull final PsiElement element) {
        return element instanceof YangDecimal64Specification;
    }

    @Override
    public void performCheck(@NotNull final PsiElement element, @NotNull final AnnotationHolder holder) {
        minOne.check(element, holder, YangFractionDigitsStmt.class);
        maxOne.check(element, holder, YangFractionDigitsStmt.class);
        maxOne.check(element, holder, YangRangeStmt.class);
